...
// is derived from the issue: closed = done, otherwise its kanban label, else todo.
...
export function columnFor(issue: { state: string; labels: readonly string[] }): ColumnId {
